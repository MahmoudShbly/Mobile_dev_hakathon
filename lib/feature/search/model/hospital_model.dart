...
final List<Hospital> searchHospitals = [
  Hospital(
    ...
    phone: '+966501234567',
    medicines: [searchMedicines[0], searchMedicines[1]],
  ),
  Hospital(
  ...
  Hospital(
    ...
    phone: '+966503456789',
    medicines: [searchMedicines[0], searchMedicines[2]],
  ),
];
