...
import 'package:mobile_dev_hakathon/feature/search/presentation/screens/widgets/pharmacy_list.dart';
import 'package:mobile_dev_hakathon/feature/search/presentation/screens/widgets/search_field.dart';
import 'package:mobile_dev_hakathon/feature/search/presentation/screens/widgets/search_results_header.dart';
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          // Pharmacy List Widget
          Expanded(
            child: PharmacyList(
              pharmacies: _allPharmacies,
            ),
          ),
        ],
      ),
